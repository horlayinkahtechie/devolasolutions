...
export const metadata = {
  ...
  keywords: [
    ...
    "hire a graphic designer Nigeria",
    "graphic designer for hire Nigeria",
    "freelance graphic designer Nigeria",
    "brand identity package Nigeria",
    "startup branding designer Nigeria",
    "rebrand my business Nigeria",
    "packaging design Nigeria",
    "UI UX designer for hire Nigeria",
    "website design and branding Nigeria",
